...
class Cluster:
    ...
    def splinter_off_better_cluster(
        self, do_kmeans: Callable[[list[Datapoint]], KMeans]
    ) -> Cluster:
    ...
    def _get_separated_dataset(
        self, cluster_result: list[int]
    ) -> tuple[list[list[Datapoint]], list[list[int]]]:
